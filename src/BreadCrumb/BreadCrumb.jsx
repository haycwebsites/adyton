...
const BreadCrumb = ({ title, home }) => {
  ...
  return (
    <section className="bg-[url('/images/LuxurySuites/590780018.jpg')] bg-[rgba(0,0,0,0.42)] bg-blend-multiply bg-no-repeat bg-cover h-[550px] bg-center grid items-center justify-center">
