        ...
        <section className="Container py-20 lg:py-[120px]">
          ...
          >
            ...
            <p className="font-Lora leading-[26px] text-gray dark:text-lightGray font-normal text-sm sm:text-base">
              Insights on luxury long-stay living, lease terms and what makes
              ADYTON Mykonos the ideal private compound for executives and
              families.
            </p>
          </div>
          {/* all blogs are here */}
              ...
              {blogPosts.slice(0, 3).map((post, index) => (
                <div key={post.id} className="keen-slider__slide number-slide1 ">
                  <div
                    ...
                    data-aos={index === 0 ? "fade-up-left" : index === 2 ? "fade-up-right" : "fade-up"}
                    data-aos-duration="1000"
                  >
                    <div className="relative">
                      <img
                    ...
                    <div className="font-Garamond border border-[#e8e8e8] dark:border-[#424242] border-t-0">
                      <div className="py-6 px-[30px] lg:px-5 xl:px-[25px] ">
                        ...
                        <Link to="/blog_details" state={{ blog: post }}>
