...
const Rooms = () => {
  ...
  const roomSlides = [
    { image: r.roomImage1, name: r.room1 },
    { image: r.roomImage2, name: r.room2 },
    { image: r.roomImage3, name: r.room3 },
  ];
  ...
  return (
    <div className="bg-whiteSmoke dark:bg-lightBlack">
      <div className="relative z-[1] ">
        ...
        >
          <div className="p-3">
            <p className="text-sm text-lightGray ml-3">{t(r.checkInLabel)}</p>
          ...
          <div className="p-3">
            <p className="text-sm text-lightGray ml-3">{t(r.checkOutLabel)}</p>
            <div className="flex items-center pt-[2px] ">
              <input
                type="date"
                className="border-none bg-transparent focus:outline-transparent focus:border-transparent text-white focus:border-none outline-0  text-sm lg:text-base focus:ring-transparent"
